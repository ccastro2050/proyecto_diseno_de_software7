...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15458`.
...
| Port | `15458` | El puerto del host del compose (`15458:1433`) |
...
> El puerto es la clave: **15458, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15458
...
>
> ```
> Error opening connection Failed to connect to localhost:15458
...
> (`http://localhost:8063/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15458) con test y guardarla |
