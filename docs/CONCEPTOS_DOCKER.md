...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15458"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11458"| SQLSERVER
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13352"| MARIADB
```
