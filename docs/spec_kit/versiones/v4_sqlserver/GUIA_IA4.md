...
**Sus puertos:** API 8163 · PostgreSQL 15558 · **SQL Server 11558**
...
1. **Carpeta nueva de specs** y copia desde el clon del curso (ajuste la
   ...
   Copy-Item ..\proyecto_diseno_de_software7\docs\spec_kit\versiones\v4_sqlserver\* docs\spec_kit\versiones\v4_sqlserver\
   ```
...
2. **La BD SQL Server y su inicializador** — cópielos tal cual del clon
   ...
   ```powershell
   Copy-Item ..\proyecto_diseno_de_software7\db\bdfacturas_sqlserver.sql db\
   Copy-Item ..\proyecto_diseno_de_software7\db\init_sqlserver.sh db\
   ```
...
- El ancla de stack queda igual; a los puertos +100 agregue:
  *"SQL Server publica en 11558 (no 11458)"*.
