...
| `docker-compose.yml` | ★ servicio `mariadb` (11, :13352, se siembra solo) + `ConnectionStrings__MariaDb` |
...
- Puertos publicados: 8063 (API) · 15458 (postgres) · 11458 (sqlserver)
  · **13352 (mariadb)**. Reconstrucción del estudiante: +100 (13452).
