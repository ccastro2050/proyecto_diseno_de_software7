...
Servicios: postgres · sqlserver (+init) · mariadb · api-facturas (:8063) ·
**front-flask (:8064)**.
...
# 3b. EN EL NAVEGADOR — http://localhost:8064
...
curl.exe http://localhost:8063/api/producto            # los mismos 8 de la tabla
```
